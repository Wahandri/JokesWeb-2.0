...
export default function UserData() {
  ...
  const handleChangeUsername = async () => {
    ...
    try {
      // Realiza una solicitud para cambiar el nombre de usuario
  ...
  return (
    <>
      ...
      <div className='flexCenterColums boxComponent'>
        <div className='boxArea'>
          <p>Nombre de usuario actual: <span className='greenColor'>{user.username}</span></p>
          <input
            type='text'
